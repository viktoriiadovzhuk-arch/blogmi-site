...
export default async (req) => {
  ...
  try {
    ...
    // Meta event_id для дедуплікації Pixel ↔ CAPI
    const metaEventId = "rest_" + crypto.randomBytes(12).toString("hex");

    // UTM: пріоритет — з клієнта, fallback — з booking
    ...
    // Зберігаємо посилання у самій броні теж + UTM/event_id
    ...
    const widgetParams = {
      ...
      language: "UA",
      returnUrl: SITE_URL + "/thankyou?ref=" + orderReference,
